...
# Automated release script for unvenv
...
log_info "Monitor the release at: https://github.com/workhelix/unvenv/actions"
log_info "Release will be available at: https://github.com/workhelix/unvenv/releases/tag/unvenv-v$NEW_VERSION"